              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-6">
                  <div className="glass p-6 rounded-[2.5rem] flex flex-col items-center min-w-[100px] border-primary/20 hover:scale-110 transition-transform cursor-help">
                    <span className="text-4xl font-black text-primary leading-none">{data.globalScore || 0}</span>
            ...
            <TabsContent value="alchemy" className="space-y-8 mt-0">
               <div className="grid md:grid-cols-2 gap-8">
                  {data.bonusTips?.expressRecipe ? (
                    ...
                    <div className="glass rounded-[3.5rem] p-12 flex items-center justify-center text-muted-foreground">Recette indisponible.</div>
                  )}
